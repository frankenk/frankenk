...
<!--START_SECTION:feed-->
* [Google Analytics data transfer to U.S. brings * [Google Analytics data transfer to U.S. brings * [New Python tool checks NPM packages for manifest confusion issues](https://www.bleepingcomputer.com/news/security/new-python-tool-checks-npm-packages-for-manifest-confusion-issues/)
